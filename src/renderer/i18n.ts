...
const STRINGS: Table = {
  ...
  'history.save': { ja: '保存', en: 'Save' },
  'history.save.hint': { ja: 'Markdown ファイルに保存', en: 'Save as a Markdown file' },
  ...
  'history.saved': { ja: 'Markdown を保存しました', en: 'Saved as Markdown' },
  ...
  'tr.save': { ja: 'ファイルに保存', en: 'Save to file' },
  'tr.save.title': { ja: 'Markdown ファイルに保存', en: 'Save as a Markdown file' },
  'tr.saved': { ja: '保存しました', en: 'Saved' },
